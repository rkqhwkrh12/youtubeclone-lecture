...
import { protectorMiddleware, publicOnlyMiddleware, avartarUpload } from "../middlewares";
...
userRouter.route("/edit").all(protectorMiddleware).get(getEdit).post(avartarUpload.single("avatar"),postEdit);
